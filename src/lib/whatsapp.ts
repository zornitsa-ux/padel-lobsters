...
export async function shareToLobstersGroup(message: string): Promise<void> {
...
export function shareToDirectChat(phone: string | null | undefined, message: string): boolean {
