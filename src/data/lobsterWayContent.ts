...
// ── Content shape ────────────────────────────────────────────────────────────
export interface LobsterWayListRow {
  emoji?: string
  label?: string
  text?: string
}

export interface LobsterWayStep {
  title: string
  text: string
  image?: string
}

export interface LobsterWayItem {
  q: string
  a?: string
  list?: LobsterWayListRow[]
  steps?: LobsterWayStep[]
  note?: string
}

export interface LobsterWayCategory {
  slug: string
  label: string
  chipEmoji?: string
  isStory?: boolean
  story?: string
  items?: LobsterWayItem[]
}

const LOBSTER_WAY_CONTENT: LobsterWayCategory[] = [
  {
    slug: 'origin-story',
    label: 'Origin story',
    chipEmoji: '🦞',
...
export function resolveLobsterWayContent(
  settings:
    | {
