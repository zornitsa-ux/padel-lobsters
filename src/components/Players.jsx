              ...
              >
                ...
                <div className="px-5 py-3 bg-amber-50 border-b border-amber-100">
                  ...
                  <p className="text-xs text-amber-700">
                    ...
                    <strong>{perfPlayers}</strong> player{perfPlayers === 1 ? '' : 's'}. Everyone
                    else gets historical, welcome, or generic level-based reviews.
                  </p>
                </div>
                ...
                (() => {
                  ...
                  const nemesis =
                    Object.entries(stats.h2h)
                      ...
                      .filter(Boolean)
                      .sort((a, b) => b.lost - b.won - (a.lost - a.won) || b.lost - a.lost)[0] ||
                    null
                  ...
                  const totalEvents =
                    stats.playerTournaments.length +
                  ...
                  return (
                    <div className="mt-3 pt-3 border-t border-gray-100 space-y-3">
                      ...
                      <div className="flex items-center gap-1.5 text-xs text-gray-500">
                        ...
                        <span
                          className={
                            parseFloat(p.adjustment) >= 0 ? 'text-green-600' : 'text-red-500'
                          }
                        >
                        ...
                        <span>→</span>
                        <span
                          className={`font-bold px-1.5 py-0.5 rounded ${levelBadge(p.adjustedLevel)}`}
                        >
                          {(p.adjustedLevel || 0).toFixed(1)}
                        </span>
                      </div>
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-2 gap-1.5 text-xs">
                            ...
                            <div className="bg-gray-50 rounded-lg px-2.5 py-1.5">
                              ...
                              <span className="text-gray-700 font-bold">
                                {stats.avgPointsFor.toFixed(1)} –{' '}
                                {stats.avgPointsAgainst.toFixed(1)}
                              </span>
                            </div>
                          ...
                          <div className="flex flex-col gap-1 text-xs">
                            ...
                            {worstPartner && worstPartner.name !== bestPartner?.name && (
                              <div className="flex items-center justify-between bg-amber-50 rounded-lg px-2.5 py-1.5">
                                <span className="text-gray-700">
                                  💔 <span className="font-semibold">Jinx partner</span> ·{' '}
                                  {worstPartner.name}
                                </span>
          ...
          <div className="bg-white rounded-3xl w-full max-w-sm p-6 space-y-5 text-center shadow-xl">
            ...
            <div className="bg-gray-50 rounded-xl p-3 text-left space-y-1.5">
              <p className="text-xs font-semibold text-gray-600">
                Save this PIN — you'll use it to:
              </p>
                      ...
                      {isAdmin ? (
                        <>
                          ...
                          <p className="text-xs text-amber-700 mt-1">
                            <strong>{mergePlayer.name}</strong> is already in the system. Update
                        ...
                        <>
                          ...
                          <p className="text-xs text-amber-700 mt-1">
                            Your profile already exists — you've played in a past Lobster
                            tournament. Finish setting up your profile and we'll link everything
                            together.
                          </p>
                        </>
                      )}
