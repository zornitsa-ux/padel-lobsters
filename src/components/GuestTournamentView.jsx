  ...
  return (
    <div className="max-w-2xl mx-auto p-4 space-y-5">
      ...
      <h1 className="text-xl font-extrabold text-gray-800 flex items-center gap-2">
        <Trophy size={18} className="text-lob-teal" />
        ...
        return (
          ...
          >
            ...
            <button
              ...
              className="w-full bg-lob-teal text-white font-bold text-sm py-2.5 rounded-xl flex items-center justify-center gap-2 hover:bg-teal-700 transition disabled:opacity-60"
              disabled={isFull}
