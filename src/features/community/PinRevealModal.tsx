  ...
  return (
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl w-full max-w-sm p-6 space-y-5 text-center shadow-xl">
        ...
        <div>
          <h2 className="text-xl font-bold text-lob-dark">Welcome, {pinReveal.name}!</h2>
          <p className="text-sm text-lob-muted mt-1">Here's your personal access PIN:</p>
        </div>
        ...
        <div className="bg-gray-50 rounded-xl p-3 text-left space-y-1.5">
          <p className="text-xs font-semibold text-lob-slate">Save this PIN — you'll use it to:</p>
          <p className="text-xs text-lob-muted">🦞 Register for events and check your stats</p>
          <p className="text-xs text-lob-muted">📋 Confirm your identity in the app</p>
          <p className="text-xs text-lob-muted">🔒 Keep your account secure</p>
        </div>
        <p className="text-[10px] text-lob-muted-light">Ask the admin if you ever lose your PIN</p>
